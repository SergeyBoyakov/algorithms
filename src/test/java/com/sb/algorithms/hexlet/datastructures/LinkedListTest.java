...
//        }
    ...
    public void testNext() {
        ...
        try {
            iter.next();
            fail("next do not throw exception on total empty collection");
        } catch (final NoSuchElementException e) {
        }

        testInstance.add(1);
        testInstance.add(2);
        final ListIterator<Integer> secondIter = testInstance.listIterator();
        assertEquals((Integer) 1, secondIter.next());
        assertEquals((Integer) 2, secondIter.next());
